  ...
  useEffect(() => {
    ...
    const calculatePosition = () => {
      ...
      const languageButton = document.querySelector(
        'button[aria-label*="Language"], button[aria-label*="Dil"], button[aria-label*="Idioma"], button[aria-label*="Langue"], button[aria-label*="Sprache"], button[aria-label*="Lingua"], button[aria-label*="Язык"], button[aria-label*="اللغة"], button[aria-label*="言語"], button[aria-label*="语言"]',
      );
