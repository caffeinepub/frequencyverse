...
import type { KidsSleepSound } from "../lib/kidsSleepSounds";

interface KidsSleepSoundCardProps {
  sound: KidsSleepSound;
  isPlaying: boolean;
  onToggle: () => void;
...
export default function KidsSleepSoundCard({
  sound,
  isPlaying,
  onToggle,
  isInPlaylist = false,
  ...
  const getSoundTitle = () => {
    return t.kidsSleepSounds[sound.category][sound.title];
  };
