  ...
  useEffect(() => {
    ...
    const calculatePosition = () => {
      ...
      const themeButton = document.querySelector(
        'button[aria-label*="Theme"], button[aria-label*="Tema"], button[aria-label*="Thème"], button[aria-label*="Thema"], button[aria-label*="Тема"], button[aria-label*="السمة"], button[aria-label*="テーマ"], button[aria-label*="主题"]',
      );
